...
Route::get('/vehicles', [VehicleController::class, 'index'])->name('rents.index');
Route::post('/vehicles', [VehicleController::class, 'store'])->name('rents.store');
Route::get('/rents', [VehicleController::class, 'fetchRents'])->name('rents.fetch');
Route::delete('/vehicles/{id}', [VehicleController::class, 'destroy'])->name('rents.destroy');
...
Route::get('/fetch-accessories', [AccessoriesController::class, 'fetchAccessories'])->name('product.fetch');
Route::get('/accessory-details/{id}', [AccessoriesController::class, 'show'])->name('product.show');

Route::get('/files', [FileController::class, 'index'])->name('files.index');
Route::get('/files/fetch', [FileController::class, 'fetchFiles'])->name('files.fetch'); 
