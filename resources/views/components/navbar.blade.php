<!-- Navbar Start -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <img src="{{ asset('img/cosmic1.png') }}" alt="" width="150" height="150"/>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="/service" class="nav-item nav-link">Accessories</a>
                <a href="/products" class="nav-link ">Cosplay</a>
                <a href="/files" class="nav-link ">Templates</a>               
    ...
    <span id="cart-count" class="badge bg-danger rounded-circle" style="position: absolute; top: 10px; right: 350px;">0</span>
            ...
            @endif
            <a href="/rents" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Rent Now<i class="fa fa-arrow-right ms-3"></i></a>
