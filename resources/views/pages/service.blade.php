...
@section('header')
                <h1 class="display-3 text-white mb-3 animated slideInDown">Accessories</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Accessories</li>
                    </ol>
                </nav>
@endsection
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="bg-white p-2 shadow-md">
                                    <div class="text-center">
                                        <a href="#">
                                            <img src="/storage/${product.image}" alt="${product.name}" height="300px">
                                        </a>
                                    </div>
                    ...
                    window.location.href = `{{ url('api/accessory-details/${productId}') }}`;
            });
                }
            });
        });
